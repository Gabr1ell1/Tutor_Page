...
INSERT INTO `dependentes` (`id_responsavel`, `nome_dependente`, `nasc`, `cpf`, `id_dependente`, `id_sexo`, `tel_emergencia`, `endereco`, `foto`) VALUES
...
INSERT INTO `responsavel` (`Id_responsavel`, `nome`, `email`, `cpf`, `telefone`, `nasc`, `id_sexo`, `senha`, `foto`) VALUES
